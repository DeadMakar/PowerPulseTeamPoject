...
`,ui=({categories:n})=>{const e=Pe(),[r,o]=p.useState(!1),[t,a]=p.useState(""),[u,l]=p.useState(!1),[i,s]=p.useState(""),[c,d]=p.useState(""),[m,g]=p.useState(""),E=n.map(C=>C[0].toUpperCase()+C.slice(1).toLowerCase()),x=C=>[...C.map(w=>({value:w,label:w}))],f=[{value:"all",label:"All"},{value:"recommended",label:"Recommended"},{value:"not-recommended",label:"Not recommended"}],v=C=>{C&&C.preventDefault();const w={title:i||"",category:c||"",groupBloodNotAllowed:m||"all"};if(!(i.length<=40))a(`Please enter up to 30 characters, now ${i.length}`),l(!0);else{a(""),l(!1);try{e(oe(w))}catch{Me.error("Sorry, something went wrong, please try again",{theme:"dark"})}}},P=C=>{const w=C.target.value;o(w.length>0),s(w)},D=()=>{o(!1),s(""),e(oe({title:"",category:c||"",groupBloodNotAllowed:m||"all"}))},I=C=>{const w=C?C.value:null;d(w),e(oe({title:i||"",category:w||"",groupBloodNotAllowed:m||"all"}))},A=C=>{const w=C?C.value.toLowerCase():"all";g(w),e(oe({title:i||"",category:c||"",groupBloodNotAllowed:w||"all"}))};return h.jsxs(h.Fragment,{children:[h.jsxs(Zo,{onSubmit:v,noValidate:!0,children:[h.jsxs(Jo,{children:[h.jsx(Qo,{type:"text",name:"title",placeholder:"Search",value:i,onChange:P}),h.jsxs(ei,{children:[r&&h.jsx("button",{type:"button",onClick:D,children:h.jsx(ni,{children:h.jsx("use",{href:ee+"#icon-x"})})}),h.jsx("button",{type:"submit",children:h.jsx(ti,{children:h.jsx("use",{href:ee+"#icon-search"})})})]}),u&&h.jsxs(ai,{children:[h.jsx("svg",{children:h.jsx("use",{href:ee+"#icon-checkbox-circle-fill"})}),t]})]}),h.jsxs(ri,{children:[h.jsx(it,{id:at(),options:x(E),value:x(E).find(C=>C.value===c),isSearchable:!1,isMulti:!1,isClearable:!0,onChange:I,placeholder:"Categories",styles:oi}),h.jsx(it,{id:at(),options:f,value:f.find(C=>C.value===m),isSearchable:!1,isMulti:!1,isClearable:!0,onChange:A,placeholder:"All",styles:ii})]})]}),h.jsx(p.Suspense,{fallback:h.jsx(Ae,{}),children:h.jsx(jt,{})})]})},si=M.ul`
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
...
`,pi=({product:n,type:e,handleOpenModal:r})=>{const o=d=>[...d.map(m=>m[0].toUpperCase()+m.slice(1).toLowerCase())],{title:t,category:a,calories:u,weight:l}=n,i=o([t])[0],s=o([a])[0];let c;return e?c="Recommended":c="Not recommended",h.jsxs(Ht,{children:[h.jsx(Wt,{children:"DIET"}),h.jsxs("div",{style:{display:"flex",gap:"16px",alignSelf:"flex-end",flexWrap:"wrap"},children:[h.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[h.jsx(je,{children:e?h.jsx("use",{href:ee+"#icon-Ellipse-82",style:{fill:b.colorSecondaryGreen,stroke:b.colorSecondaryGreen}}):h.jsx("use",{href:ee+"#icon-Ellipse-82",style:{fill:b.colorSecondaryRed,stroke:b.colorSecondaryRed}})}),h.jsx(be,{children:c})]}),h.jsxs(Ut,{onClick:()=>r(n),children:["Add",h.jsx(je,{style:{width:"16px",height:"16px"},children:h.jsx("use",{href:ee+"#icon-arrow",style:{stroke:b.colorOrange}})})]})]}),h.jsxs(_t,{children:[h.jsx("svg",{style:{flexShrink:0,width:"24px",height:"24px"},children:h.jsx("use",{href:ee+"#icon-running-stick-figure-svgrepo-com-1"})}),h.jsx(Nt,{children:i})]}),h.jsxs(zt,{children:[h.jsxs(be,{children:[h.jsx("span",{children:"Calories:"}),u]}),h.jsxs(Gt,{children:[h.jsx("span",{children:"Category:"}),s]}),h.jsxs(be,{children:[h.jsx("span",{children:"Weight:"}),l]})]})]})},fi=M.div`
  padding: 48px 24px;
...
`,yi=({productTitle:n,calories:e,productId:r,onClick:o,closeModallAddProductForm:t})=>{const a=Pe(),[u,l]=p.useState({product:"",date:"",amount:"",calories:""}),[i,s]=p.useState(0),[c,d]=p.useState(""),[m,g]=p.useState(!1),f=Yt(new Date).split("/"),v=`${f[0]}-${f[1]}-${f[2]}`,P=n[0].toUpperCase()+n.slice(1).toLowerCase(),D=async()=>{try{t(),o(u.calories),a(qt(u))}catch{Me.error("Sorry, something went wrong, please try again",{theme:"dark"})}},I=A=>{const C=parseFloat(A.target.value),w=parseFloat(e);if(!isNaN(C)&&!isNaN(w)){const F=Math.round(C*w/100);s(F),l({productId:r,date:v,amount:C,calories:F}),d(""),g(!1)}else s(e),l({productId:"",date:"",amount:"",calories:""})};return h.jsx(fi,{children:h.jsx(an,{initialValues:{name:"",mass:""},onSubmit:D,children:h.jsxs(hi,{children:[h.jsxs(mi,{children:[h.jsx(gi,{type:"text",name:"name",value:P,disabled:!0}),h.jsx(vi,{type:"number",name:"calories",autoComplete:"off",required:!0,step:"1",min:"1",max:"1000",onChange:I}),h.jsx(bi,{children:"grams"})]}),h.jsxs(xi,{children:["Calories: ",h.jsx(Ei,{children:i})]}),h.jsxs(Ci,{children:[h.jsx(Lt,{type:"submit",children:"Add to diary"}),h.jsx(Si,{type:"button",onClick:()=>t(),children:"Cancel"})]})]})})})},Fi=M.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,Mi=M.svg`
  ...
  height: 16px;
  margin-left: 8px;
`,Vi="/PowerPulseTeamPoject/assets/avocado-46dd5bc9.png",ki=({calories:n,closeModalAddProductSuccess:e})=>h.jsxs(Fi,{children:[h.jsx(Oi,{src:Vi}),h.jsx(wi,{children:"Well done"}),h.jsxs(Di,{children:["Calories: ",h.jsx(Ii,{children:n})]}),h.jsx(Pi,{type:"button",onClick:()=>e(),children:"Next product"}),h.jsxs(Ai,{href:"/PowerPulseTeamPoject/diary",children:["to the Diary",h.jsx(Mi,{children:h.jsx("use",{href:`${ee}#icon-arrow`})})]})]}),Li=({products:n})=>{const e=ae(lt),[r,o]=p.useState(null),[t,a]=p.useState(!1),[u,l]=p.useState(null),i=m=>{a(!0),o(m),l(m),document.body.style.overflow="hidden"},s=()=>{t&&a(!1),o(null),l(null),document.body.style.overflow="visible"},d=ae(Kt).blood;return h.jsxs(h.Fragment,{children:[e&&h.jsx(Ae,{}),!e&&(n==null?void 0:n.length)>0&&h.jsx(si,{children:n.map(m=>h.jsx(pi,{product:m,type:m.groupBloodNotAllowed[d],handleOpenModal:i},m._id))}),!e&&(n==null?void 0:n.length)<=0&&h.jsxs(li,{children:[h.jsxs(ci,{children:[h.jsx("span",{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),h.jsx(di,{children:"Try changing the search parameters."})]}),r&&h.jsx(Xt,{isOpen:t,onRequestClose:s,children:typeof u=="object"?h.jsx(yi,{closeModallAddProductForm:s,calories:r.calories,productTitle:r.title,productId:r._id,product:u,onClick:i}):h.jsx(ki,{calories:u,closeModalAddProductSuccess:s})})]})},Hi=()=>{const n=Pe(),e=ae(lt),r=ae(bn),o=ae(vn);return p.useEffect(()=>{(async()=>{try{await n(oe({title:"",category:null,groupBloodNotAllowed:"all"}))}catch{Me.error("Sorry, something went wrong, please try again",{theme:"dark"})}})()},[n]),p.useEffect(()=>{n(Zt())},[n]),h.jsx(hn,{children:h.jsxs(Jt,{children:[h.jsxs(mn,{children:[h.jsx(Qt,{contentText:"Products"}),h.jsx(ui,{categories:r})]}),e?h.jsx(Ae,{}):h.jsx(gn,{children:h.jsx(Li,{products:o})})]})})};export{Hi as default};
