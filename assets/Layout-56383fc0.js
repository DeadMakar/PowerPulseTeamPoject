...
`,Ge=Q.span`
  ...
  line-height: 150%;
  color: ${H.colorWhite};
`,Je=({onClick:E})=>{const Z=be(),G=()=>{Z(_e()),E()},J=N=>{N.code==="Escape"&&E()},z=()=>{E()},B=N=>{N.currentTarget===N.target&&E()};return pe.useEffect(()=>(window.addEventListener("keydown",J),()=>{window.removeEventListener("keydown",J)})),m.jsx(Ue,{onClick:B,children:m.jsxs(He,{children:[m.jsx(Be,{onClick:z,children:m.jsx(Fe,{children:m.jsx("use",{href:`${q}#icon-x`})})}),m.jsxs(Ke,{children:[m.jsx(fe,{to:"/diary",onClick:z,children:"Diary"}),m.jsx(fe,{to:"/products",onClick:z,children:"Products"}),m.jsx(fe,{to:"/exercises",onClick:z,children:"Exercises"})]}),m.jsxs(Xe,{to:"/welcome",onClick:G,children:[m.jsx(Ge,{children:"Logout"}),m.jsx(Se,{children:m.jsx("use",{href:`${q}#icon-log-out-02`})})]})]})})},Ze=()=>{const[E,Z]=pe.useState(!1),G=()=>{Z(z=>!z)},J=we(je);return m.jsxs(Ae,{children:[m.jsxs(Ie,{children:[m.jsx(ye,{to:"/",children:m.jsx(Ce,{})}),J&&m.jsxs(ke,{children:[m.jsx(re,{minWidth:1440,children:m.jsxs(Le,{children:[m.jsx(le,{to:"/diary",children:"Diary"}),m.jsx(le,{to:"/products",children:"Products"}),m.jsx(le,{to:"/exercises",children:"Exercises"})]})}),m.jsx($e,{to:"/profile",children:m.jsx(ze,{})}),m.jsx(re,{minWidth:1440,children:m.jsx(Re,{})}),m.jsx(re,{maxWidth:1439,children:m.jsx(De,{onClick:G,children:m.jsx("use",{href:`${q}#icon-menu`})})})]})]}),m.jsx(re,{maxWidth:1439,children:E&&m.jsx(Je,{onClick:G})})]})},tt=()=>{const E=Ee(),Z=!["/","/welcome","/signup","/signin","/error"].includes(E.pathname);return m.jsxs(m.Fragment,{children:[Z&&m.jsx(Ze,{}),m.jsx(Oe,{}),m.jsx(Te,{})]})};export{tt as default};
