import{u as r,a as t,A as L,j as e,D as fe,B as A,r as y,y as me,s as f,R as ge,E as we,b as j,d as Y,f as Q,N as Z,F as ye,G as ue,H as je,I as be,C as ve,J as $e,K as De}from"./index-865ff0dd.js";import{i as Se}from"./index-1800c573.js";import{T as ke}from"./TitlePage-dcd69589.js";import{T as ze,_}from"./emotion-element-c39617d8.browser.esm-3b5ebf26.js";import"./floating-ui.dom-9d61e2db.js";const Te=r.div`
  position: relative;
  display: flex;
  align-items: center;
...
`,G=i=>i.diary.allDiaryInformation,Ue=i=>i.diary.isLoading,U=i=>i.diary.error,Je=i=>i.diary.isLoadingProducts,Ke=i=>i.diary.isLoadingExercise,xe=i=>{if(!(i instanceof Date))return null;const a=String(i.getDate()).padStart(2,"0"),o=String(i.getMonth()+1).padStart(2,"0"),l=i.getFullYear();return`${a}-${o}-${l}`},Ve=we`
  0% {
...
`,N=()=>e.jsx(Xe,{children:e.jsx(Ze,{})}),qe=({currentDate:i})=>{var s;const o=(s=j(G)[0])==null?void 0:s.productArr,l=j(Je),c=Y(),d=j(Q),h=d==null?void 0:d.blood,x=j(U),p=te("(max-width:768px)"),m=async n=>{const g=xe(i);try{await c(ye({productId:n,selectedDate:g}))}catch{A.error("Sorry, something went wrong, please try again",{theme:"dark"})}};return e.jsxs(ie,{children:[e.jsxs(ne,{children:[e.jsx(oe,{children:"Products"}),e.jsx(re,{children:e.jsxs(Z,{to:"/products",style:{display:"flex",alignItems:"center"},children:[e.jsx(se,{children:"Add product"}),e.jsx("svg",{style:{width:"16px",height:"16px",marginLeft:"8px",stroke:t.colorOrange},children:e.jsx("use",{href:f+"#icon-arrow"})})]})})]}),o&&o.length>0&&!x?p?e.jsx(B,{children:l?e.jsx(N,{}):e.jsx(e.Fragment,{children:e.jsx(M,{children:o==null?void 0:o.map(n=>{var J;const g=n==null?void 0:n.title,$=n==null?void 0:n.calories,D=n==null?void 0:n.amount,w=n==null?void 0:n._id,v=(J=n==null?void 0:n.productId)==null?void 0:J.groupBloodNotAllowed,F=n==null?void 0:n.category,W=v&&v[h]?"Yes":"No";return e.jsxs(K,{children:[e.jsx(b,{children:"Title"}),e.jsx(b,{children:g}),e.jsx(b,{children:"Category"}),e.jsx(b,{children:F}),e.jsxs(de,{children:[e.jsxs(ae,{style:{display:"flex",flexDirection:"column"},children:[e.jsx(b,{children:"Calories"}),e.jsx(b,{children:$})]}),e.jsxs(ce,{style:{display:"flex",flexDirection:"column"},children:[e.jsx(b,{children:"Weight"}),e.jsx(b,{children:D})]}),e.jsxs(he,{style:{display:"flex",flexDirection:"column"},children:[e.jsx(b,{children:"Recommend"}),e.jsx(b,{children:e.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center",height:"24px"},children:[e.jsx("svg",{style:{width:"14px",height:"14px"},children:W==="Yes"?e.jsx("use",{href:f+"#icon-Ellipse-82",style:{fill:t.colorSecondaryGreen,stroke:t.colorSecondaryGreen}}):e.jsx("use",{href:f+"#icon-Ellipse-82",style:{fill:t.colorSecondaryRed,stroke:t.colorSecondaryRed}})}),e.jsx(V,{children:W})]})})]}),e.jsxs(pe,{style:{display:"flex",flexDirection:"column"},children:[e.jsx(b,{children:""}),e.jsx(b,{children:e.jsx(R,{type:"button",onClick:()=>m(w),children:e.jsx(H,{children:e.jsx("use",{href:f+"#icon-trash-03"})})})})]})]})]},w)})})})}):e.jsx(B,{children:l?e.jsx(N,{}):e.jsxs(e.Fragment,{children:[e.jsxs(Ge,{children:[e.jsx(z,{children:"Title"}),e.jsx(z,{children:"Category"}),e.jsx(z,{children:"Calories"}),e.jsx(z,{children:"Weight"}),e.jsx(z,{children:"Recommend"}),e.jsx(z,{children:""})]}),e.jsx(M,{children:o==null?void 0:o.map(n=>{const g=n==null?void 0:n.title,$=n==null?void 0:n.calories,D=n==null?void 0:n.amount,w=n==null?void 0:n._id,v=n==null?void 0:n.productId.groupBloodNotAllowed,F=n==null?void 0:n.category,W=v&&v[h]?"Yes":"No";return e.jsxs(K,{children:[e.jsx(T,{children:g}),e.jsx(T,{children:F}),e.jsx(T,{children:$}),e.jsx(T,{children:D}),e.jsx(T,{children:e.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center",height:"24px"},children:[e.jsx("svg",{style:{width:"14px",height:"14px"},children:W==="Yes"?e.jsx("use",{href:f+"#icon-Ellipse-82",style:{fill:t.colorSecondaryGreen,stroke:t.colorSecondaryGreen}}):e.jsx("use",{href:f+"#icon-Ellipse-82",style:{fill:t.colorSecondaryRed,stroke:t.colorSecondaryRed}})}),e.jsx(V,{children:W})]})}),e.jsx(T,{children:e.jsx(R,{type:"button",onClick:()=>m(w),children:e.jsx(H,{children:e.jsx("use",{href:f+"#icon-trash-03"})})})})]},w)})})]})}):e.jsx(le,{children:"Not found products"})]})},et=r.ul`
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  /* justify-content: space-between; */
