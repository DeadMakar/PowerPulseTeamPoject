...
`,$z=()=>{const e={name:"Katy",email:"@gmail.com",height:170,currentWeight:50,desiredWeight:40,birthday:"2000-01-01",blood:"1",sex:"female",levelActivity:"3"},[t,n]=O.useState("0000-00-00"),r=l=>{const u=l.toISOString().slice(0,10);n(u);const d=new Date(u),h=new Date-d,y=1e3*60*60*24*365.25;h/y<18&&console.log("Sorry, but only adults can use our app.")},[o,i]=O.useState(!0),a=l=>{const c=Object.keys(l).some(u=>l[u]!==e[u]);i(!c),console.log(l)},s=l=>{console.log(l)};return p.jsx(Cz,{children:p.jsx(RN,{initialValues:e,validationSchema:PF,onSubmit:l=>{s(l)},children:({errors:l,touched:c})=>p.jsxs(P_,{onChange:u=>a(u),children:[p.jsx(Sz,{errors:l,touched:c,onDateChange:r}),p.jsxs(Dz,{children:[p.jsx(Zo,{children:"Blood"}),p.jsxs(Oz,{children:[p.jsxs(Sw,{children:[p.jsxs(kw,{children:[p.jsx(Fn,{name:"blood",value:"1",text:"1"}),p.jsx(Fn,{name:"blood",value:"2",text:"2"}),p.jsx(Fn,{name:"blood",value:"3",text:"3"}),p.jsx(Fn,{name:"blood",value:"4",text:"4"})]}),l.blood&&c.blood&&p.jsx(io,{children:l.blood})]}),p.jsxs(Sw,{children:[p.jsxs(kw,{children:[p.jsx(Fn,{name:"sex",value:"male",text:"Male"}),p.jsx(Fn,{name:"sex",value:"female",text:"Female"})]}),l.sex&&c.sex&&p.jsx(io,{children:l.sex})]})]})]}),p.jsxs(Tz,{children:[p.jsx(Fn,{name:"levelActivity",value:"1",text:"Sedentary lifestyle (little or no physical activity)"}),p.jsx(Fn,{name:"levelActivity",value:"2",text:"Light activity (light exercises/sports 1-3 days per week)"}),p.jsx(Fn,{name:"levelActivity",value:"3",text:"Moderately active (moderate exercises/sports 3-5 days per week)"}),p.jsx(Fn,{name:"levelActivity",value:"4",text:"Very active (intense exercises/sports 6-7 days per week)"}),p.jsx(Fn,{name:"levelActivity",value:"5",text:"Extremely active (very strenuous exercises/sports and physical work)"}),l.levelActivity&&c.levelActivity&&p.jsx(io,{children:l.levelActivity})]}),p.jsx(Pz,{type:"submit",disabled:o,children:"Save"})]})})})},jz=by`
  * {
    box-sizing: border-box;
  }
...
`,Mz=()=>p.jsxs(ns,{children:[p.jsx(qd,{contentText:"Profile Settings"}),p.jsxs(Rz,{children:[p.jsx(V4,{}),p.jsx($z,{})]})]}),gd=e=>{const t=new Date(e),n=String(t.getDate()).padStart(2,"0"),r=String(t.getMonth()+1).padStart(2,"0"),o=t.getFullYear();return`${n}/${r}/${o}`},Az=D.div`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`;const $H="/PowerPulseTeamPoject/assets/trainingGym-1-78b576d3.jpg",jH="/PowerPulseTeamPoject/assets/trainingGym-1@2x-7f8d3593.jpg",RH=Br.div`
