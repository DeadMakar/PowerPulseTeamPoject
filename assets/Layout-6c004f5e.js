...
`,Je=D.span`
  ...
  line-height: 150%;
  color: ${B.colorWhite};
`,Ze=({onClick:g})=>{const G=_e(),K=()=>{G(we()),g()},Z=N=>{N.code==="Escape"&&g()},z=()=>{g()},Y=N=>{N.currentTarget===N.target&&g()};return ve.useEffect(()=>(window.addEventListener("keydown",Z),()=>{window.removeEventListener("keydown",Z)})),p.jsx(He,{onClick:Y,children:p.jsxs(Fe,{children:[p.jsx(Ke,{onClick:z,children:p.jsx(Be,{children:p.jsx("use",{href:`${q}#icon-x`})})}),p.jsxs(Xe,{children:[p.jsx(pe,{to:"/diary",onClick:z,children:"Diary"}),p.jsx(pe,{to:"/products",onClick:z,children:"Products"}),p.jsx(pe,{to:"/exercises",onClick:z,children:"Exercises"})]}),p.jsxs(Ge,{to:"/welcome",onClick:K,children:[p.jsx(Je,{children:"Logout"}),p.jsx(Se,{children:p.jsx("use",{href:`${q}#icon-log-out-02`})})]})]})})},Ne=()=>{const[g,G]=ve.useState(!1),K=()=>{G(Y=>!Y)},Z=ne(me),z=ne(Y=>Y.auth.user.userMetrics);return p.jsxs(Ae,{children:[p.jsxs(Ie,{children:[p.jsx(je,{to:"/diary",children:p.jsx(Ce,{})}),Z&&z&&p.jsxs(Le,{children:[p.jsx(re,{minWidth:1440,children:p.jsxs(ke,{children:[p.jsx(fe,{to:"/diary",activeclassname:"active",exact:"true",children:"Diary"}),p.jsx(fe,{to:"/products",activeclassname:"active",exact:"true",children:"Products"}),p.jsx(fe,{to:"/exercises",activeclassname:"active",exact:"true",children:"Exercises"})]})}),p.jsx($e,{to:"/profile",children:p.jsx(ze,{})}),p.jsx(re,{minWidth:1440,children:p.jsx(Re,{})}),p.jsx(re,{maxWidth:1439,children:p.jsx(De,{onClick:K,children:p.jsx("use",{href:`${q}#icon-menu`})})})]})]}),p.jsx(re,{maxWidth:1439,children:g&&p.jsx(Ze,{onClick:K})})]})},rt=()=>{const g=Ee(),G=ne(me),K=["/diary","/profile","/exercises","/products"].includes(g.pathname)||g.pathname==="/"&&G;return p.jsxs(p.Fragment,{children:[K&&p.jsx(Ne,{}),p.jsx(Oe,{}),p.jsx(Te,{})]})};export{rt as default};
