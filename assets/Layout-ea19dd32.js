...
`,fe=D(ye)`
  ...
  &:hover,
  &:focus {
    background-color: ${F.colorOrange};
  }
  &.active {
    background-color: ${F.colorOrange};
  }
...
`,We=D.div`
  border: 1px solid ${F.colorOrange};
  border-radius: 50%;
  width: 37px;
  height: 37px;
  position: relative;
...
`,ze=()=>{const{user:g}=ne(G=>G.auth);return p.jsxs(p.Fragment,{children:[p.jsx(Qe,{children:p.jsx("use",{href:`${q}#icon-settings-01`})}),p.jsx(We,{children:g!=null&&g.avatarURL?p.jsx(p.Fragment,{children:p.jsx(Ue,{src:g.avatarURL,alt:"User Avatar"})}):p.jsx(Ye,{children:p.jsx("use",{href:`${q}#icon-gridicons_user`})})})]})},He=D.div`
  position: fixed;
  top: 0;
  left: 0;
...
`,Je=D.span`
  ...
  line-height: 150%;
  color: ${F.colorWhite};
`,Ze=({onClick:g})=>{const G=we(),K=()=>{G(je()),g()},Z=N=>{N.code==="Escape"&&g()},z=()=>{g()},Y=N=>{N.currentTarget===N.target&&g()};return ve.useEffect(()=>(window.addEventListener("keydown",Z),()=>{window.removeEventListener("keydown",Z)})),p.jsx(He,{onClick:Y,children:p.jsxs(Fe,{children:[p.jsx(Ke,{onClick:z,children:p.jsx(Be,{children:p.jsx("use",{href:`${q}#icon-x`})})}),p.jsxs(Xe,{children:[p.jsx(pe,{to:"/diary",onClick:z,children:"Diary"}),p.jsx(pe,{to:"/products",onClick:z,children:"Products"}),p.jsx(pe,{to:"/exercises",onClick:z,children:"Exercises"})]}),p.jsxs(Ge,{to:"/welcome",onClick:K,children:[p.jsx(Je,{children:"Logout"}),p.jsx(Se,{children:p.jsx("use",{href:`${q}#icon-log-out-02`})})]})]})})},Ne=()=>{const[g,G]=ve.useState(!1),K=()=>{G(Y=>!Y)},Z=ne(xe),z=ne(Y=>Y.auth.user.userMetrics);return p.jsxs(Ae,{children:[p.jsxs(Ie,{children:[p.jsx(me,{to:"/",children:p.jsx(Ce,{})}),Z&&z&&p.jsxs(Le,{children:[p.jsx(re,{minWidth:1440,children:p.jsxs(ke,{children:[p.jsx(fe,{to:"/diary",children:"Diary"}),p.jsx(fe,{to:"/products",children:"Products"}),p.jsx(fe,{to:"/exercises",children:"Exercises"})]})}),p.jsx($e,{to:"/profile",children:p.jsx(ze,{})}),p.jsx(re,{minWidth:1440,children:p.jsx(Re,{})}),p.jsx(re,{maxWidth:1439,children:p.jsx(De,{onClick:K,children:p.jsx("use",{href:`${q}#icon-menu`})})})]})]}),p.jsx(re,{maxWidth:1439,children:g&&p.jsx(Ze,{onClick:K})})]})},rt=()=>{const g=Ee(),G=ne(xe),K=["/diary","/profile","/exercises","/products"].includes(g.pathname)||g.pathname==="/"&&G;return p.jsxs(p.Fragment,{children:[K&&p.jsx(Ne,{}),p.jsx(Oe,{}),p.jsx(Te,{})]})};export{rt as default};
